...
const SvgHeading1 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <title>{"heading\uFF11"}</title>
    <g id="b33cd0de-98d7-4e0c-a58f-e79f133ba8e2" data-name="\u30E9\u30D9\u30EB">
      <path d="M1449.11,1130h-1l-148.24,139.29-59.7-169.13,208.94-199H1658V1627.5H1449.11Z" />
